...
public class DataBase2 {
	...
	private static DataBase2	instance;	// Instancia del objecto DataBase
	...
	private DataBase2()
	{
		try
		{
			...
			this.connection = DriverManager.getConnection("jdbc:sqlite:data/patients2.sqlite3"); 
	...
	private void create_tables()
	{
		try
		{
			...
			// data/createDB2.sql
			this.update(FileUtils.toString("data/createDB2.sql"));
		}
		catch (IOException e)
		{
			e.printStackTrace();
		}
		(new File("createDB2.sql")).delete();
	}
